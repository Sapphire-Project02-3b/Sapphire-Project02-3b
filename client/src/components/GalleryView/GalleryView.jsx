...
export default function GalleryView({searchParams, setSearchParams, filterText, classroomId, privacySetting}){
    ...
    const [GalleryEditBtn, setGalleryEditBtn] = useState(false);
        ...
        return (
            <div key={directory.id} id='gallery-class-card'>
                ...
                <div id='card-right-content-container'>
                    ...
                    <button id='copy-edit-button' onClick={() => handleCopyEdit()}>
                        <CopyIcon size={64} style={{marginTop: '0vh'}}/>/
                        <EditIcon size={64} style={{marginTop: '0vh'}}/>
                    </button>
                    <GalleryEdit trigger={GalleryEditBtn} setTrigger={setGalleryEditBtn} gallery={directory.name}>
                        <h3>Edit</h3>
                    </GalleryEdit>
